...
| OPS-003 | Switch deployment baseline to Netlify + Render + Neon | Forge | P1 | review | Vercel-first assumption removed from docs; added deployment guide for the new free-tier baseline |
