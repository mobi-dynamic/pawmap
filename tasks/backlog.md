...
| BE-004 | Add Google ingestion + canonical upsert path for geography seeding | Raven | P0 | review | Added deterministic Google normalization/upsert path, DB CLI ingest command, sample Fitzroy seed file, and tests; live Google API collection/hydration still remains for a follow-up slice |
